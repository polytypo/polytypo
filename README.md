...
Spec version: **1.3.0** · locales: **18** · rules: **9**.
...
| `fr-CA` | Elle a dit : « Ce n’est pas la librairie qu’on appelle “le coin”, si? » … On a marché — presque 3 km — pour la trouver fermée. Copyright © 2026; le tirage fait 40×60 cm. |
