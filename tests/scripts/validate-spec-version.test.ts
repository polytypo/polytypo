...
describe("scripts/validate-spec.mjs — global spec-version drift, fixture roots included", () => {
  ...
  it("passes on this repository's real, current spec/ with exactly 19 verified claimants", () => {
    ...
    expect(output).toContain("global spec version: 19 claimant(s) match spec/VERSION");
