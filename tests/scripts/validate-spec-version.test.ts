...
describe("scripts/validate-spec.mjs — global spec-version drift, fixture roots included", () => {
  ...
  it("passes on this repository's real, current spec/ with exactly 15 verified claimants", () => {
    ...
    expect(output).toContain("global spec version: 15 claimant(s) match spec/VERSION");
